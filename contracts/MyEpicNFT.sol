...
contract MyEpicNFT is ERC721URIStorage {
    ...
    constructor() ERC721("Wrangle Nicrome", "WN") {
    ...
    function makeAnEpicNFT() public {
        ...
        require(newItemId < 50, "SOLD OUT || Mint limit reached");
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        first,
                        '", "description": "A Wrangle Nichrome Brand.", "image": "data:image/svg+xml;base64,',
